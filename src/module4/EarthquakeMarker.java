...
public abstract class EarthquakeMarker extends SimplePointMarker
{
	...
	public static final float THRESHOLD_DEEP = 200;
	...
	public void draw(PGraphics pg, float x, float y) {
		...
		// System.out.println((String) getProperty("age"));
		
		if (((String) getProperty("age")).equals("Past Hour")) {
...
//			pg.text("X", x, y);
	...
	private void colorDetermine(PGraphics pg) {
		...
		if (depth < THRESHOLD_INTERMEDIATE) {
			...
			pg.fill(red);
			// System.out.println("this earthquake is deep");
		}
	}
